...
import 'package:estibafy_company_app/UI/auth/otp_screen_user.dart';
import 'package:estibafy_company_app/UI/navBar.dart';
import 'package:estibafy_company_app/UI/widgets/backButton.dart';
import 'package:estibafy_company_app/services/goole_place_search/google_places_web.dart';
...
class CompanyCreateAddressScreen extends StatefulWidget {
  CompanyCreateAddressScreen({Key? key, required this.image}) : super(key: key);

  final File image;

  @override
  State<CompanyCreateAddressScreen> createState() => _CompanyCreateAddressScreenState();
}

class _CompanyCreateAddressScreenState extends State<CompanyCreateAddressScreen> {
                          ...
                          MaterialButton(
                              ...
                              onPressed: () {
                                if (_formKey.currentState!.validate()) {
                                  FirebasePhoneAuth()
                                    .sendSms(authController.countryCode.value + authController.contactControllerSignup.text);
                                    Get.to(OtpScreen());
                                }
                              },
                              child: Padding(
