...
import '../goole_place_search/prediction_tile.dart';
...
class FlutterGooglePlacesWeb extends StatefulWidget {
  ...
  final bool required;
  final Function(Address) selectedResults;
...
class FlutterGooglePlacesWebState extends State<FlutterGooglePlacesWeb>
  ...
  Future<List<Address>> getLocationResults(String inputText) async {
    ...
    for (var i = 0; i < predictions.length; i++) {
      ...
      String city = terms[terms.length - 3]['value'];
      String state = terms[terms.length - 2]['value'];
  ...
  selectResult(Address clickedAddress) {
    setState(() {
      FlutterGooglePlacesWeb.showResults = false;
      controller.text = clickedAddress.streetAddress;
      ...
      FlutterGooglePlacesWeb.value['state'] = clickedAddress.state;
